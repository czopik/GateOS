const els = {
  ...
  hallEnabled: document.getElementById('hallEnabled'),
  hallPps: document.getElementById('hallPps'),
...
async function loadStatus() {
  try {
    ...
    setText(els.hallEnabled, boolLabelUnknown(inputs.hallEnabled));
    setText(els.hallPps, typeof inputs.hallPps === 'number' ? inputs.hallPps.toFixed(2) : 'NO DATA');
    setText(els.hallCount, fmtNum(inputs.hallCount));
    ...
    setText(els.hallEnabled, 'NO DATA');
    setText(els.hallPps, 'NO DATA');
    setText(els.hallCount, 'NO DATA');
