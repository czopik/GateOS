...
const statusEls = {
  ...
  hallPpsValue: document.getElementById('hallPpsValue'),
  hallCountValue: document.getElementById('hallCountValue'),
...
function updateSensorStatus(data) {
  ...
  const hallCount = typeof inputs.hallCount === 'number' ? inputs.hallCount : 0;
  ...
  setStatusText(statusEls.hallPpsValue, hallEnabled ? hallPps.toFixed(2) : 'inactive');
  setStatusText(statusEls.hallCountValue, hallEnabled ? `${hallCount}` : 'inactive');
  if (!photocellEnabled) {
