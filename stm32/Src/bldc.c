...
int16_t        batVoltage       = (400 * BAT_CELLS * BAT_CALIB_ADC) / GATE_BAT_CALIB_REAL_VOLTAGE;
static int32_t batVoltageFixdt  = (400 * BAT_CELLS * BAT_CALIB_ADC) / GATE_BAT_CALIB_REAL_VOLTAGE << 16;  // Fixed-point filter output initialized at 400 V*100/cell = 4 V/cell converted to fixed-point
...
void DMA1_Channel1_IRQHandler(void) {
  ...
  /* Make sure to stop motors in case of an error; consider RIGHT channel only when enabled */
